        ...
        <div class="" style="margin-top:70px;">
            ...
            <div class="max-w-sm bg-white rounded-lg border border-purple-200 shadow-md dark:bg-purple-600 dark:border-purple-700">
                ...
                <div class="p-5">
                    ...
                    <a href="srs7.php" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-fuchsia-400 dark:hover:bg-cyan-300 dark:focus:ring-gray-50">
                        Show more
                        <svg aria-hidden="true" class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                        </svg>
