...
--
-- Host: 127.0.0.1:3308
-- Waktu pembuatan: 04 Des 2022 pada 13.57
...
CREATE TABLE `irs` (
  ...
  `semester_mhs` int(2) DEFAULT NULL,
...
INSERT INTO `irs` (`id_irs`, `nim_mhs`, `semester_mhs`, `sks`, `berkas_irs`) VALUES
(5, '24060120000004', 4, 12, 'Poisson Kumulat_if.pdf'),
(7, '24060120000004', 3, 12, 'Poisson Kumulat_if.pdf'),
(12, '24060120000004', 1, 12, 'kuliah_11.pdf'),
(15, '24060120000004', 7, 12, 'Print Kartu UTS.pdf'),
(16, '24060120000004', 5, 14, 'Print Kartu UTS.pdf');
...
INSERT INTO `khs` (`id_khs`, `nim_mhs`, `semester_mhs`, `sks_semester`, `ip_semester`, `berkas_khs`) VALUES
(1, '24060120000004', 6, 121, 3.72, '');
...
INSERT INTO `mahasiswa` (`nama_mhs`, `NIM`, `angkatan`, `sem_aktif`, `status_mhs`, `jalur_masuk`, `jenis_kelamin`, `alamat`, `id_provinsi`, `id_kabupaten`, `email`, `nohp`) VALUES
('Rake Keylana Wangsa', '24000000000001', '2020', 5, 'Aktif', 'SNMPTN', 'Laki-laki', 'Jl.Semarang', 1, 1677, 'rakewangsa@gmail.com', '080000000001'),
('Hanan Nurul Zain', '24000000000002', '2019', 7, 'Aktif', 'SNMPTN', 'Perempuan', 'Jl.Depok', 1, 1678, 'hananzain@gmail.com', '080000000002'),
('Andira Faqih Muhammad', '24000000000003', '2018', 9, 'Aktif', 'Mandiri', 'Laki-laki', 'Jl.Bekasi', 1, 1679, 'andirafaqih@gmail.com', '080000000003'),
('Muhammad Kurnia Fathurahman', '24000000000004', '2018', 9, 'Aktif', 'SNMPTN', 'Laki-laki', 'Jl.Jambi', 1, 1680, 'kurniafathur@gmail.com', '080000000004'),
('Aulia Kafita Putri', '24000000000005', '2020', 5, 'Cuti', 'Mandiri', 'Perempuan', 'Jl.Semarang', 1, 1681, 'auliakafita@gmail.com', '080000000005'),
('Benhard Simanullang', '24000000000006', '2017', 11, 'Aktif', 'SNMPTN', 'Laki-laki', 'Jl.Jakarta', 1, 1682, 'benhardsimanullang@gmail.com', '080000000006'),
('Charisto Marc Gybran', '24000000000007', '2019', 7, 'Cuti', 'SBMPTN', 'Laki-laki', 'Jl.Solo', 1, 1683, 'charistomarc@gmail.com', '080000000007'),
('Fahrel Gibran', '24000000000008', '2019', 7, 'Cuti', 'SBMPTN', 'Laki-laki', 'Jl.Yogyakarta', 1, 1684, 'fahrelgibran@gmail.com', '080000000008'),
('Fayza Aulia', '24000000000009', '2018', 9, 'Aktif', 'Mandiri', 'Perempuan', 'Jl.Aceh', 1, 1685, 'fayzaaulia@gmail.com', '080000000009'),
('Farah Tisti Paranpara', '24000000000010', '2017', 11, 'Aktif', 'Mandiri', 'Perempuan', 'Jl.Bandung', 1, 1686, 'farahtisti@gmail.com', '080000000010'),
('Satria Reza Ramadhan', '24060120000004', '2020', 5, 'Aktif', 'SBMPTN', 'Laki-laki', 'Jambi', 9, 1809, 'satria@gmail.com', '087657293734');
...
('24000000000001', 'Sudah', 'A', '1'),
('24000000000002', 'Belum', '-', '-'),
('24000000000003', 'Sudah', 'B', '3'),
('24000000000004', 'Belum', '-', '-'),
('24000000000005', 'Sudah', 'E', '5'),
('24000000000006', 'Belum', '-', '-'),
('24000000000007', 'Sudah', 'C', '7'),
('24000000000008', 'Belum', '-', '-'),
('24000000000009', 'Sudah', 'D', '9'),
('24000000000010', 'Belum', '-', '-');
...
CREATE TABLE `skripsi` (
  ...
  `nilai_skripsi` varchar(1) NOT NULL,
  `sks_kumulatif` int(5) NOT NULL,
  `tanggal_sidang` date NOT NULL,
  `ba_skripsi` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `skripsi` (`nim_mhs`, `status_skripsi`, `nilai_skripsi`, `sks_kumulatif`, `tanggal_sidang`, `ba_skripsi`) VALUES
('24000000000001', 'Sudah', 'A', 101, '2022-04-12', '1'),
('24000000000002', 'Sudah', 'A', 102, '2022-04-11', '2'),
('24000000000003', 'Sudah', 'B', 103, '2022-04-10', '3'),
('24000000000004', 'Sudah', 'C', 104, '2022-04-09', '4'),
('24000000000005', 'Belum', '-', 0, '0000-00-00', '-'),
('24000000000006', 'Belum', '-', 0, '0000-00-00', '-'),
('24000000000007', 'Belum', '-', 0, '0000-00-00', '-'),
('24000000000008', 'Sudah', 'E', 108, '2022-04-08', '8'),
('24000000000009', 'Sudah', 'D', 109, '2022-04-07', '9'),
('24000000000010', 'Belum', '-', 0, '0000-00-00', '-');
...
('197404011999031002', '123', 'dosen'),
('24060120000004', '123', 'mahasiswa'),
('24060120000092', '9b0ead26', 'mahasiswa'),
('24060120130052', '123', 'mahasiswa'),
('benynugroho', 'inggih...', 'operator'),
('informatika', '123', 'departemen');
...
--
ALTER TABLE `khs`
  ADD PRIMARY KEY (`id_khs`) USING BTREE,
  ADD KEY `khs_ibfk_1` (`nim_mhs`);
...
--
ALTER TABLE `irs`
  MODIFY `id_irs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `irs`
  ADD CONSTRAINT `irs_ibfk_1` FOREIGN KEY (`nim_mhs`) REFERENCES `mahasiswa` (`NIM`) ON DELETE CASCADE;
...
--
ALTER TABLE `khs`
  ADD CONSTRAINT `khs_ibfk_1` FOREIGN KEY (`nim_mhs`) REFERENCES `mahasiswa` (`NIM`) ON DELETE CASCADE;

--
-- Ketidakleluasaan untuk tabel `mahasiswa`
--
ALTER TABLE `mahasiswa`
  ADD CONSTRAINT `mahasiswa_ibfk_1` FOREIGN KEY (`id_provinsi`) REFERENCES `provinsi` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `mahasiswa_ibfk_2` FOREIGN KEY (`id_kabupaten`) REFERENCES `kabupaten` (`id`) ON DELETE CASCADE;
COMMIT;
