...
if (!isset($_POST['submit'])) {
    ...
    //Query update
    if ($scanIRS == ''){
        $query = "UPDATE irs SET sks='$sks' WHERE nim_mhs='$nim' AND semester_mhs='$semester'";
    }
    else{
        $query = "UPDATE irs SET sks='$sks', berkas_irs='$scanIRS' WHERE nim_mhs='$nim' AND semester_mhs='$semester'";
    }
    ...
    <div class="container flex">
        ...
        <div class="card sky-blue-50 grow" style="padding:50px 70px; margin-top: 10vh; margin-bottom:10vh; margin-right:5vw;">
            <div class="card-header mb-2" style="font-size: 30px">
                <p class="text-gray-700 font-extrabold  ">Edit Data IRS</p>
            </div>
            <div class="card-body">
                <form method="POST" name="fIRS" action="" class="grid dropzone" onsubmit="return validateForm()" enctype="multipart/form-data">
                    ...
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="">
                        Upload Scan IRS <span class="text-gray-500 ml-5">*Kosongan jika tidak ada perubahan file</span>
                    </label>
                    <div class="upload-irs ">
                        <div class="mb-7 upload-file bg-gray-200">
                            ...
                            <span id="icon-up"><i class="fas fa-file-alt text-gray-700"></i></span>
