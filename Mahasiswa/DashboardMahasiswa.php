            ...
            <div class="card-body mr-5">
                <form action="">
                    ...
                    <div class="flexbox-container cont2 ml-5">
                        <a href="Data_IRS_mhs.php"><button type="button" class="inline-block px-1 py-10 bg-indigo-600 text-white font-medium text-sm leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-40 pb-14">Entry IRS</button></a>
                        <a href="Data_KHS_mhs.php"><button type="button" class="inline-block px-10 py-10 bg-indigo-600 text-white font-medium text-sm leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-40 pb-14">Entry KHS</button></a>
